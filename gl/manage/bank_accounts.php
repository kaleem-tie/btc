	...
	if ($input_error != 1)
	{
    	if ($selected_id != -1) 
    	{
    		...
    		update_bank_account($selected_id, $_POST['account_code'],
				...
				$_POST['bank_vat_no'],check_value('is_petty_cash_account'),
				$_POST['bank_vat_act']);
    	...
    	else 
    	{
    		...
    		add_bank_account($_POST['account_code'], $_POST['account_type'], 
				...
				$_POST['BankAccountCurrency'], $_POST['dflt_curr_act'], $_POST['bank_charge_act'],$_POST['bank_vat_no'],
				check_value('is_petty_cash_account'),$_POST['bank_vat_act']);
...
{
 	$selected_id = -1;
	$_POST['bank_name']  = 	$_POST['bank_account_name']  =  $_POST['bank_vat_no']= '';
	$_POST['bank_account_number'] = $_POST['bank_address'] = $_POST['bank_vat_act'] = '';
...
$th = array(_("Id #"),_("Account Name"), _("Type"), _("Currency"), _("GL Account"), 
	_("Bank"), _("Number"), _("VAT No"), _("Bank Address"), _("Dflt"),
	_("Is it Petty Cash Account"), '','');
...
while ($myrow = db_fetch($result)) 
{
	...
	label_cell($myrow["bank_vat_no"], "nowrap");
	...
	if ($myrow["is_petty_cash_account"]==1)
		label_cell(_("Yes"), "align='center'");
	else
...
if ($selected_id != -1) 
{
  if ($Mode == 'Edit') {	
	...
	$_POST['bank_vat_no'] = $myrow["bank_vat_no"];
	$_POST['is_petty_cash_account'] = $myrow["is_petty_cash_account"];
	$_POST['bank_vat_act'] = $myrow["bank_vat_act"];
  }
...
check_row(_("Is it Petty Cash Account:"), 'is_petty_cash_account');
...
text_row(_("VAT No:"), 'bank_vat_no', null, 30, 60);
gl_all_accounts_list_row(_("VAT on Bank Charges Account:"), 'bank_vat_act', null, true);
