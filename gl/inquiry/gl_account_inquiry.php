...
function show_results()
{
    ...
    if (!isset($_POST['Dimension2']))
    	$_POST['Dimension2'] = 0;
	$result = get_gl_summary_transactions($_POST['TransFromDate'], $_POST['TransToDate'], -1,
	...
	while ($myrow = db_fetch($result))
	{
		...
		if($myrow["person_id"] == 0) {
			$name = 'Payments';
			switch ($myrow['person_type_id']) {
				case '1':
					$name = 'Work Order Payments';
					break;
				case '2':
				...
				case '3':
					...
					break;
				case '4':
					$name = 'Quick Entry Payments';
					break;
				case '5':
					$name = 'Dimesion Payments';
					break;
				default:
					$name = 'Other Payments';
					break;
