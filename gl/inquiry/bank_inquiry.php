...
$th = array(_("Type"), _("#"), _("Reference"), _("Date"),
	_("Debit"), _("Credit"), _("Balance"), _("Person/Item"), _("Cheque No."), 
	_("Memo"), "", "");
table_header($th);
...
while ($myrow = db_fetch($result))
{
	...
	$is_it_pettycash   = is_it_gl_pettycash_trans($myrow["trans_no"]);
	
	if($myrow['type'] == ST_BANKPAYMENT && $is_it_pettycash>0){
	label_cell("");
	}	
    else{
