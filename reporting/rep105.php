...
***********************************************************************/
$page_security = 'SA_SALES_ORDER_STATUS_LISTREP';
// ----------------------------------------------------------------
// $ Revision:	2.0 $
// Creator:	Joe Hunt
// date_:	2005-05-19
...
function GetSalesOrders($from, $to, $category=0, $location=null, $backorder=0, $folk=0)
{
...
function print_order_status_list()
{
	...
	$result = GetSalesOrders($from, $to, $category, $location, $backorder, $folk);
