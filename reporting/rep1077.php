...
//			}
			...
			$rep->SetCommonData($myrow, $branch, $sales_order, $baccount, ST_SALESINVOICE_REP, $contacts);
			
			
			$rep->SetHeaderType('Header67');	
			$rep->NewPage();
			// calculate summary start row for later use
			
			
			
			$summary_start_row = $rep->bottomMargin + (23* $rep->lineHeight);
