...
function print_customer_orders()
{
	...
	$cols = array(0, 80,120,280,350, 400, 500);
	  ...
	  foreach($unique_sale_tran_dates as $day_sale)
	   {
		  ...
		  $rep->AmountCol(5, 6,  $sales_data[$day_sale]['taxable_value']+ $sales_data[$day_sale]['ov_roundoff']+ $sales_data[$day_sale]['tax_value'],3);
		  $rep->NewLine();
		  $k++;
