...
function print_deliveries()
{
	...
	$cols = array(2, 25, 100, 270, 300, 350, 410, 470, 530);

	// $cols = array(2, 30, 130, 400, 450, 500);
	//$cols = array(2, 15, 95, 225, 275, 325, 380, 450, 500);

	// $headers in doctext.inc
	$aligns = array('left',	'left',	'left', 'center', 'right', 'right', 'right', 'right');
	...
	for ($i = $from; $i <= $to; $i++)
	{
			...
			while ($myrow2=db_fetch($result))
			{
				...
				$DisplayUnitTax = number_format2($myrow2["unit_tax"],$dec);
				$DisplayFullUnitPrice = number_format2($myrow2["FullUnitPrice"],$dec);
				...
				//$rep->TextCol(5, 6,	$myrow2['unit_price'], -2);		
                $rep->AmountCol(5, 6, $myrow2['unit_price'],$dec);				
				$rep->TextCol(6, 7,	$DisplayUnitTax, -2);				
				$rep->TextCol(7, 8,	$DisplayFullUnitPrice, -2);				
				$rep->row = $newrow;
				$k++;
				$rep->NewLine(0.5);
				...
				$rep->TextCol(4, 5,	$DisplayFOCQty, -2);	
				
				$rep->TextCol(5, 6,	_("FOC"), -2);
