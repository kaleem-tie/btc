...
function get_invoices($supplier_id, $to, $all=true)
{
	...
	if ($all)
    	$value = "(trans.ov_amount + trans.ov_gst + trans.ov_discount+trans.freight_cost+trans.additional_charges+trans.packing_charges+trans.other_charges+
	    trans.freight_tax+trans.additional_tax+trans.packing_tax+trans.other_tax+trans.ov_roundoff)";
    else
    	$value = "IF (trans.type=".ST_SUPPINVOICE." OR trans.type=".ST_BANKDEPOSIT.", 
    	(trans.ov_amount + trans.ov_gst + trans.ov_discount +trans.freight_cost+trans.additional_charges+trans.packing_charges+trans.other_charges+trans.freight_tax+trans.additional_tax+trans.packing_tax+trans.other_tax + trans.ov_roundoff - (trans.alloc)),
    	(trans.ov_amount + trans.ov_gst + trans.ov_discount  +trans.freight_cost+trans.additional_charges+trans.packing_charges+trans.other_charges+trans.freight_tax+trans.additional_tax+trans.packing_tax+trans.other_tax+ trans.ov_roundoff + trans.alloc))";
	...
	$sql = "SELECT trans.type,
		...
		FROM ".TB_PREF."suppliers supplier,
	   	...
	   	WHERE supplier.supplier_id = trans.supplier_id
			...
			AND ABS(trans.ov_amount + trans.ov_gst + trans.ov_discount +trans.freight_cost+trans.additional_charges+trans.packing_charges+trans.other_charges+trans.freight_tax+trans.additional_tax+trans.packing_tax+trans.other_tax+trans.ov_roundoff) > ".FLOAT_COMP_DELTA;
	if (!$all)
		$sql .= " AND ABS(trans.ov_amount + trans.ov_gst + trans.ov_discount +trans.freight_cost+trans.additional_charges+trans.packing_charges+trans.other_charges+trans.freight_tax+trans.additional_tax+trans.packing_tax+trans.other_tax+trans.ov_roundoff) - trans.alloc > ".FLOAT_COMP_DELTA;
...
function print_aged_supplier_analysis()
{
	...
	$cols = array(0, 100, 130, 180,	230, 280, 330, 385, 450,515);
	$headers = array(_('Supplier'),	'',	'',	_('Current'), $nowdue, $pastdue1,$pastdue2,$pastdue3,
		_('Total Balance'));
	...
	// $aligns = array('left',	'left',	'left',	'right', 'right', 'right', 'right',	'right');
    	...
    	$params =   array( 	0 => $comments,
                    ...
                    6 => array('text' => _('Show Also Allocated'), 'from' => $show, 'to' => ''),		
