...
function getTransactions($category, $location, $fromcust, $from, $to, $show_service, $subcategory=0)
{
	$from = date2sql($from);
	$to = date2sql($to);
...
function print_inventory_sales()
{
   ...
   // $fromsupp = $_POST['PARAM_5'];
    ...
    $params =   array( 	0 => $comments,
						...
						7 => array('text' => _('Show Summary'), 'from' => $show_summary, 'to' => ''));
	...
	$res = getTransactions($category, $location, $fromcust, $from, $to, $show_service, $subcategory);
	...
	while ($trans=db_fetch($res))
		{
			...
			if ($catt != $trans['cat_description'])
			{
				if ($catt != '')
				{
                    ...
                    if ($total2!=0)
	                $total_profit_percent = (($total2/ $total1)*100);
                    else
                    $total_profit_percent = 0;
                    $rep->AmountCol(7, 8, $total_profit_percent, $dec);
    ...
    if ($grandtotal2!=0)
	$grand_total_profit_percent = (($grandtotal2/ $grandtotal1)*100);
    else
    $grand_total_profit_percent = 0;
    $rep->AmountCol(7, 8, $grand_total_profit_percent, $dec);
