...
class setup_app extends application
{
	function __construct()
	{
		...
		$this->add_lapp_function(0, _("&Linking Location-Dimension-CashAccount"),
			"admin/loc_dim_cashact.php?", 'SA_LOC_DIM_CASHACT', MENU_SETTINGS);	
		...
		$this->add_lapp_function(1, _("Shipping Te&rms"),
			"admin/shipping_terms.php?", 'SA_SHIPPING_TERMS', MENU_MAINTENANCE);	
        /*	
        ...
        */
		...
		$this->add_lapp_function(2, _("&Void Transaction Inquiry Details"),
			"admin/void_transaction_view.php?", 'SA_VOIDTRANSACTION_INQUIRY', MENU_MAINTENANCE);	
