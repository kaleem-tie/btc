...
{
	echo "<center>" . _("Item:"). "&nbsp;";
	echo sales_items_list('stock_id', $_POST['stock_id'], true, true, '', array('editable' => false));
	echo "<hr></center>";
}
else
	br(2);
...
$th = array(_("Currency"), _("Sales Type"), _("Price"), "", "", "BarCode");
table_header($th);
...
while ($myrow = db_fetch($prices_list))
{
	...
	echo "<td><a href='".$path_to_root."/inventory/manage/viewbarcode.php?barcode=".$_POST['stock_id']."&sales_price=".$myrow["price"]."' target='_blank'>View</a></td>"; 
    end_row();
