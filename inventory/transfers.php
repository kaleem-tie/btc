...
if(list_updated('tot') || list_updated('ToStockLocation') || list_updated('indent_id') || list_updated('stock_id'))
{
	$Ajax->activate('_page_body');
}

if(list_updated('FromStockLocation')){
...
if (isset($_GET['AddedID'])) 
{
	...
	$intransit=0;
	$location_to=get_stock_transfer_loc_to1($trans_no);
	...
	submenu_option(_("&View this transfer"),
		"/inventory/view/view_transfer.php?trans_no=".$trans_no."&intransit=1'");	
...
if (isset($_POST['Process']))
{
	...
	$trans_no = add_stock_transfer($_SESSION['transfer_items']->line_items,
		...
		$_POST['AdjDate'], $_POST['ref'], $_POST['memo_'],$_POST['indent_num'],$_POST['tot'],$_POST['indent_id']);
...
function handle_update_item()
{
	...
	unset($_POST['stock_id'],$_POST['qty']);
	line_start_focus();
}
