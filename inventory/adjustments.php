...
if (isset($_GET['AddedID'])) 
{
  ...
  if (is_fixed_asset($row['mb_flag'])) {
    ...
    display_note(get_trans_view_str($trans_type, $trans_no, _("&View this adjustment")));
	 ...
	 hyperlink_params($path_to_root . "/inventory/view/print_inv_adjustment_inquiry.php?id=".$trans_no, _("Print this Adjustment"), "");
...
function can_process()
{
	...
	if ($_POST['adj_type'] == 0)
	{
		display_error(_("Select a adjustment type."));
		set_focus('adj_type');
		return false;
	}
...
if (isset($_POST['Process']) && can_process()){
  ...
  $fixed_asset = $_SESSION['adj_items']->fixed_asset; 
	...
	$trans_no = add_stock_adjustment($_SESSION['adj_items']->line_items,
		$_POST['StockLocation'], $_POST['AdjDate'],	$_POST['ref'], 
		$_POST['memo_'], $_POST['adj_type']);
