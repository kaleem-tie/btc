...
{
	if (get_post('fixed_asset') == 1) {
		stock_items_list_cells(_("Item:"), 'stock_id', null,
			_("Select a Item"), false, check_value('show_inactive'), false, array('fixed_asset' => true));
		...
		stock_costable_items_list_cells(_("Item:"), 'stock_id', null, _("Select a item"), true);
}
