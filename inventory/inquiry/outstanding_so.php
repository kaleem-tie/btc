...
***********************************************************************/
$page_security = 'SA_OUTSTANDING_SO';
$path_to_root = "../..";
...
$result = get_sql_for_outstanding_so(ST_SALESORDER,'OutstandingOnly',$_POST['stock_id'], $_POST['AfterDate'] ,$_POST['BeforeDate']);
div_start('doc_tbl');
start_table(TABLESTYLE , "width='100%'");
$th = array(_("Voucher No"), _("Voucher Date"), _("Shipping Company"), _("Customer Name"), _("SO Qty"), _("Base Rate"), _("Pending Qty"), _("Pending Amt"), _("Edd"), _("Cust Ref No"), _("Currency"));
