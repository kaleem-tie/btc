...
$transfer_items = get_stock_transfer($trans_no,$intransit);
...
start_row();
label_cells(_("From Location"), $transfer_items['from_loc']." ".$transfer_items['from_name'], "class='tableheader2'");
...
{
	$to_location = $transfer_items['to_loc']." ".$transfer_items['to_name'];
}	

label_cells(_("To Location"),$to_location, "class='tableheader2'");
end_row();


/*
start_row();
label_cells(_("Indent Number"), $transfer_items['indent_num'], "class='tableheader2'");
end_row();
*/
...
$th = array(_("S. No"),_("Item"), _("Description"),  _("Quantity"), _("Units"));
table_header($th);
$transfer_items1 = get_stock_moves(ST_LOCTRANSFER, $trans_no);
...
{
	if ($item['loc_code'] == $transfer_items['to_loc'])
	{
...
<!-- <h4 style='float:right;color:#6E6B6B;margin-right:5%;'>FOR DIVYASHAKTI POLYMERS</h4> -->
<br>
