...
page(_($help_context = "Offers - Items"), false, false, "", $js);
...
function edit_link($row)
{
	...
	return pager_link( _("Edit"),
			"/inventory/manage/promotional_discounts_items_edit.php?pd_id=" . $row["id"], ICON_EDIT);
}
...
function display_rows()
{
	...
	$sql = get_all_pagination_items_promotional_discounts();
	
	$cols = array(
	    _("Offer Name") => array('ord' =>''),
		_("Item Code") => array('ord' =>''),
		_("Item Name") => array('ord' =>''),
		_("From Date") => array('type'=>'date', 'ord' =>''),
		_("To Date") => array('type'=>'date', 'ord' =>''),
		_("Discount %") => array('ord' =>'','align'=>'center'),
