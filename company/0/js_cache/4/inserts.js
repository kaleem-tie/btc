...
var pathname=window.location.pathname;var origin=window.location.origin;var subpath=pathname.split('/');var urlFile=origin;var fixedAssetUrl=window.location.href;var url=new URL(fixedAssetUrl);var FixedAsset=url.searchParams.get("FixedAsset");if(FixedAsset==1){var fixedURLPath='stock_items_list_fixed_assets_search.php';}else{var fixedURLPath='stock_items_list_search.php';}
