...
function _set_combo_input(e){$(document).ready(function(){$(".combo").select2();$(".combo2").select2();$("#code_id").select2();$("#account").select2();$("#account_code").select2();})
var pathname=window.location.pathname;var origin=window.location.origin;var subpath=pathname.split('/');var urlFile=origin+'/'+subpath[1];var fixedAssetUrl=window.location.href;var url=new URL(fixedAssetUrl);var FixedAsset=url.searchParams.get("FixedAsset");if(FixedAsset==1){var fixedURLPath='stock_items_list_fixed_assets_search.php';}else{var fixedURLPath='stock_items_list_search.php';}
$(document).ready(function(){$(".customer_list_search").select2({ajax:{url:urlFile+"/ajax_dropdown/customer_list_search.php",
dataType:'json',
delay:250,
...
});});$(document).ready(function(){$(".stock_items_list_search").select2({ajax:{url:urlFile+"/ajax_dropdown/"+fixedURLPath,
dataType:'json',
delay:250,
data:function(params){return{q:params.term
};},
...
minimumInputLength:3,
});});$(document).ready(function(){$(".stock_items_list_search_sales").select2({ajax:{url:urlFile+"/ajax_dropdown/stock_items_list_search_sales.php",
dataType:'json',
delay:250,
data:function(params){return{q:params.term
};},
...
minimumInputLength:3,
});});$(document).ready(function(){$(".stock_costable_items_list_cells_search").select2({ajax:{url:urlFile+"/ajax_dropdown/stock_costable_items_list_cells_search.php",
dataType:'json',
delay:250,
data:function(params){return{q:params.term
};},
...
minimumInputLength:3,
});});$(document).ready(function(){$(".sales_items_list_search").select2({ajax:{url:urlFile+"/ajax_dropdown/sales_items_list_search.php",
dataType:'json',
delay:250,
data:function(params){return{q:params.term
};},
...
minimumInputLength:3,
});});$(document).ready(function(){$(".stock_disposable_fa_list_cells_search").select2({ajax:{url:urlFile+"/ajax_dropdown/stock_disposable_fa_list_cells_search.php",
dataType:'json',
delay:250,
data:function(params){return{q:params.term
};},
...
minimumInputLength:3,
});});$(document).ready(function(){$(".stock_categories_list_search").select2({ajax:{url:urlFile+"/ajax_dropdown/stock_categories_list_search.php",
dataType:'json',
delay:250,
data:function(params){return{q:params.term
};},
...
minimumInputLength:3,
});});$(document).ready(function(){$(".inv_supplier_items_cells_search").select2({ajax:{url:urlFile+"/ajax_dropdown/inv_supplier_items_cells_search.php",
dataType:'json',
delay:250,
data:function(params){return{q:params.term
};},
...
minimumInputLength:3,
});});$(document).ready(function(){$(".service_items_list_cells_search").select2({ajax:{url:urlFile+"/ajax_dropdown/service_items_list_cells_search.php",
dataType:'json',
delay:250,
data:function(params){return{q:params.term
};},
...
minimumInputLength:3,
});});e.setAttribute('_last',e.value);e.onblur=function(){var but_name=this.name.substring(0,this.name.length-4)+'button';var button=document.getElementsByName(but_name)[0];var select=document.getElementsByName(this.getAttribute('rel'))[0];save_focus(select);if(button&&(this.value!=this.getAttribute('_last'))){JsHttpRequest.request(button);}else if(string_contains(this.className,'combo2')){this.style.display='none';select.style.display='inline';setFocus(select);}
...
$('#branch_id').select2();$('#supplier_id').select2();$('#stock_id').select2();$('#SelectStockFromList').select2();$('#code_id').select2();$('#person_id').select2();$('#account').select2();}
function _update_box(s){$(document).ready(function(){$(".combo").select2();$(".combo2").select2();$("#code_id").select2();$("#account").select2();$("#account_code").select2();})
var pathname=window.location.pathname;var origin=window.location.origin;var subpath=pathname.split('/');var urlFile=origin+'/'+subpath[1];var fixedAssetUrl=window.location.href;var url=new URL(fixedAssetUrl);var FixedAsset=url.searchParams.get("FixedAsset");if(FixedAsset==1){var fixedURLPath='stock_items_list_fixed_assets_search.php';}else{var fixedURLPath='stock_items_list_search.php';}
$(document).ready(function(){$(".customer_list_search").select2({ajax:{url:urlFile+"/ajax_dropdown/customer_list_search.php",
dataType:'json',
delay:250,
...
minimumInputLength:3,
});});e.setAttribute('_last',e.selectedIndex);e.onblur=function(){var box=document.getElementsByName(this.getAttribute('rel'))[0];if((this.selectedIndex!=this.getAttribute('_last'))
...
'.amount':function(e){
    if(e.onblur==undefined){e.setAttribute('_last_val',e.value);e.onblur=function(){var dec=this.getAttribute("dec");var val=this.getAttribute('_last_val');if(val!=get_amount(this.name)){this.setAttribute('_last_val',get_amount(this.name));price_format(this.name,get_amount(this.name),dec);if(e.className.match(/\bactive\b/))
