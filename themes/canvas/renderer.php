...
<?php 				
				...
				echo "<h1><img src='$path_to_root/themes/default/images/header_logo.png' alt='Tech Integra ERP'  height='40' width='120' /><span style='padding-left:300px;padding-bottom:10px;'><img id='ajaxmark' src='$indicator' align='center' style='visibility:hidden;'></span></h1>\n";
			...
			{		
				...
				switch ($sel_app) // Shortcuts
				{
				  ...
				  if($sel_app!='system' && $sel_app!='complaints'){
