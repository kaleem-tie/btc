	...
	class renderer
	{
		...
		function menu_header($title, $no_menu, $is_index)
		{
			...
			if (!$no_menu)
			{
				...
				echo "<h1><img src='$path_to_root/themes/default/images/header_logo.png' alt='Tech Integra ERP'  height='33' width='130' /><span style='padding-left:300px;padding-bottom:10px;'><img id='ajaxmark' src='$indicator' align='center' style='visibility:hidden;'></span></h1>\n";
