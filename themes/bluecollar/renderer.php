	...
	class renderer
	{
		...
		function menu_header($title, $no_menu, $is_index)
		{
			...
			if (!$no_menu)
			{
				...
				echo "<h1><img src='$path_to_root/themes/default/images/header_logo.png' alt='Tech Integra ERP'  height='30' width='120' /><span style='padding-left:300px;padding-bottom:10px;'><img id='ajaxmark' src='$indicator' align='center' style='visibility:hidden;'></span></h1>\n";
				echo "</div>\n"; // header
				echo "<ul id='saturday'>\n"; // horizontal menu
				foreach($applications as $app)
				{
		...
		function menu_footer($no_menu, $is_index)
		{
			...
			if (!$no_menu)
			{
				...
				{
					echo "<span class='power'><a target='_blank' href='$SysPrefs->power_url'>$SysPrefs->power_by</a></span>\n";
				}
				echo "</div>\n"; // footer
			}
		...
		?>   
			     ...
			     <script type='text/javascript' src="https://techintegraerp.com/bgma/ajax_dropdown/select2/dist/js/select2.min.js" defer></script>
				  <link href="https://techintegraerp.com/bgma/ajax_dropdown/select2/dist/css/select2.min.css" rel='stylesheet' type='text/css'>
				<script type='text/javascript' src="https://techintegraerp.com/bgma/ajax_dropdown/select2/jquery-3.0.0.js"></script>
