...
var fixedAssetUrl = window.location.href;
var url = new URL(fixedAssetUrl);
var FixedAsset = url.searchParams.get("FixedAsset");
//console.log(c);
//alert(FixedAsset);
	
	if(FixedAsset==1){
		var fixedURLPath = 'stock_items_list_fixed_assets_search.php';
		
	}else{
		var fixedURLPath = 'stock_items_list_search.php';
		
	}	

///////////////////////////////////////////////////////////////////
	    $(document).ready(function(){
               $(".customer_list_search").select2({
                ajax: {
                    url: urlFile+"/ajax_dropdown/customer_list_search.php",
                   // type: "post",
                    dataType: 'json',
                    delay: 250,
...
///////////////////////////////////////////////////////////////////
	    $(document).ready(function(){
               $(".stock_items_list_search").select2({
                ajax: {
                  url: urlFile+"/ajax_dropdown/"+fixedURLPath,
                  // url: urlFile+"/ajax_dropdown/stock_items_list_search.php",
                   // type: "post",
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {						
...
///////////////////////////////////////////////////////////////////
 $(document).ready(function(){
               $(".stock_items_list_search_sales").select2({
                ajax: {
                    url: urlFile+"/ajax_dropdown/stock_items_list_search_sales.php",
                   // type: "post",
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {						
...
///////////////////////////////////////////////////////////////////
 ...
 $(document).ready(function(){
               $(".stock_costable_items_list_cells_search").select2({
                ajax: {
                    url: urlFile+"/ajax_dropdown/stock_costable_items_list_cells_search.php",
                   // type: "post",
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {						
...
/////////////////////////////////////////////////////////////////////////////	
		    $(document).ready(function(){
               $(".sales_items_list_search").select2({
                ajax: {
                    url: urlFile+"/ajax_dropdown/sales_items_list_search.php",
                   // type: "post",
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {						
...
////////////////////////////////////////////////////////	
	    ...
	    $(document).ready(function(){
               $(".stock_disposable_fa_list_cells_search").select2({
                ajax: {
                    url: urlFile+"/ajax_dropdown/stock_disposable_fa_list_cells_search.php",
                   // type: "post",
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {						
...
////////////////////////////////////////////////////////
 $(document).ready(function(){
               $(".stock_categories_list_search").select2({
                ajax: {
                    url: urlFile+"/ajax_dropdown/stock_categories_list_search.php",
                   // type: "post",
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {						
...
///////////////////////////////////////////////////////////////	
	    $(document).ready(function(){
               $(".inv_supplier_items_cells_search").select2({
                ajax: {
                    url: urlFile+"/ajax_dropdown/inv_supplier_items_cells_search.php",
                   // type: "post",
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {						
...
////////////////////////////////////////////////////////
	    ...
	    $(document).ready(function(){
               $(".service_items_list_cells_search").select2({
                ajax: {
                    url: urlFile+"/ajax_dropdown/service_items_list_cells_search.php",
                   // type: "post",
                    dataType: 'json',
                    delay: 250,
                    data: function (params) {						
