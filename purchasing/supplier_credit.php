...
function commit_item_data($n)
{
	if (check_item_data($n))
	{
		$_SESSION['supp_trans']->add_grn_to_trans($n,
			...
			$_POST['std_cost_unit'.$n], "",$_POST['discount_percent'.$n]);
		reset_tax_input();
	}
}
...
if ($_POST['supplier_id']=='') 
	...
	invoice_totals($_SESSION['supp_trans'],1); // # ramesh added for ov amount calculating wrong when credit this invoice. 
