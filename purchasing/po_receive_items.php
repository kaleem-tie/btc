...
function display_po_receive_items()
{
   ...
   $th = array(_("S.No."),_("Item Code"), _("Description"), _("Ordered"), _("Units"), _("Received"),
...
function can_process()
{
	...
	if (!check_reference($_POST['ref'], ST_INVSUPPRECEIVE))
	{
		set_focus('ref');
		return false;
	}
...
if (isset($_GET['PONumber']) && $_GET['PONumber'] > 0 && !isset($_POST['Update']))
{
	...
	$_SESSION['PO']->trans_type = ST_INVSUPPRECEIVE;
	$_SESSION['PO']->reference = $Refs->get_next(ST_INVSUPPRECEIVE, null,
