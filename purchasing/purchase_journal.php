...
if (isset($_GET['ModifyOrderNumber']) && is_numeric($_GET['ModifyOrderNumber'])) {
 ...
 elseif (isset($_GET['NewGRN'])) {
	...
	create_new_po(ST_SUPPINVOICE, 0,"",0,'PJ');
	copy_from_cart();
	...
	if (isset($_GET['FixedAsset'])) {
		...
		$_SESSION['page_title'] = _($help_context = "Purchase Journal Entry");
}
...
display_purchase_journal_header($_SESSION['PO']);
echo "<br>";

display_purchase_journal_items($_SESSION['PO']);
