...
function defaultCompany()
{
	...
	$title = $login_timeout ? _('Authorization timeout') : $SysPrefs->app_title." - "._("Login");
	...
	// echo "<body id='loginscreen' style='background-image:url(themes/default/images/vec_bg2.jpg); background-repeat: no-repeat; align:left; background-size: 100%;' ; $onload>\n";
	echo "<body id='loginscreen' style='background-image:url($path_to_root/themes/default/images/vec_bg2.jpg); background-repeat: no-repeat; align:left; background-size: 100%;' ;";
	echo "<table class=''><tr><td>&nbsp;</td></tr></table>\n";
	...
	if (!$login_timeout) { // FA logo
    	echo "<a target='_blank' href='".$SysPrefs->power_url."'><img src='$path_to_root/themes/$def_theme/images/logo_frontaccounting.png' alt='LOGO' height='50' onload='fixPNG(this)' border='0' ></a>";
	} else { 
	...
	if (!$login_timeout)
		table_section_title(_("Solutions Simplified"));
