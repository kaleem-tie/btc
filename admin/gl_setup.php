...
if (isset($_POST['submit']) && can_process())
{
	update_company_prefs( get_post( array( 'retained_earnings_act', 'profit_loss_year_act',
		...
		'roundoff_act','purchase_freight_act','additional_charges_act','packing_charges_act','other_charges_act','purchase_roundoff_act','intransit_act',
		'sales_vat_advance','cash_sales_act','pdc_act')));
...
$_POST['roundoff_act'] = $myrow["roundoff_act"];
$_POST['purchase_freight_act'] = $myrow['purchase_freight_act'];
$_POST['additional_charges_act'] = $myrow['additional_charges_act'];
$_POST['packing_charges_act'] = $myrow['packing_charges_act'];
$_POST['other_charges_act'] = $myrow['other_charges_act'];
$_POST['purchase_roundoff_act'] = $myrow["purchase_roundoff_act"];
$_POST['intransit_act'] = $myrow['intransit_act'];
$_POST['sales_vat_advance'] = $myrow['sales_vat_advance'];

$_POST['cash_sales_act'] = $myrow['cash_sales_act'];
$_POST['pdc_act'] = $myrow['pdc_act'];
...
gl_all_accounts_list_row(_("Credit Sales Account:"), 'default_sales_act', null,
	false, false, true);
	
	
gl_all_accounts_list_row(_("Cash Sales Account:"), 'cash_sales_act', null,
	false, false, true);	
...
gl_all_accounts_list_row(_("Round Off Charged Account:"), 'roundoff_act', $_POST['roundoff_act']);


//gl_all_accounts_list_row(_("PDC Accrued Account:"), 'pdc_act', $_POST['pdc_act']);

gl_all_accounts_list_row(_("VAT Advance Account:"), 'sales_vat_advance', $_POST['sales_vat_advance']);
...
//purchase shipping account
gl_all_accounts_list_row(_("Purchase Shipping Charged Account:"), 'purchase_freight_act', $_POST['purchase_freight_act']);

gl_all_accounts_list_row(_("Purchase Additional Charges Account:"), 'additional_charges_act', $_POST['additional_charges_act']);

gl_all_accounts_list_row(_("Purchase Packing Charges Account:"), 'packing_charges_act', $_POST['packing_charges_act']);

gl_all_accounts_list_row(_("Purchase Other Charges Account:"), 'other_charges_act', $_POST['other_charges_act']);

gl_all_accounts_list_row(_("Purchase Round Off Charged Account:"), 'purchase_roundoff_act', $_POST['purchase_roundoff_act']);
...
gl_all_accounts_list_row(_("In transit Account:"), 'intransit_act', $_POST['intransit_act']);
