	...
	if ($input_error != 1)
	{
		update_company_prefs(
			get_post( array('coy_name','coy_no','gst_no','tax_prd','tax_last',
				...
				'po_auth_req_amount','tax_id_no','cr_no','cr_date','dg_fin_code','vat_renewal_date'))
		);
...
$_POST['tax_id_no'] = $myrow['tax_id_no'];
$_POST['cr_no'] = $myrow['cr_no'];
$_POST['cr_date'] = $myrow['cr_date'];
$_POST['vat_renewal_date'] = ($myrow['vat_renewal_date']);
$_POST['dg_fin_code']=$myrow["dg_fin_code"];
$_POST['po_auth_req_amount'] = $myrow["po_auth_req_amount"];
...
text_row_ex(_("Tax Id No:"), 'tax_id_no', 25);
text_row_ex(_("CR No:"), 'cr_no', 25);
date_row(_("CR Date:"),'cr_date');

text_row_ex(_("VAT No:"), 'gst_no', 25);

date_row(_("VAT Renewal Date:"),'vat_renewal_date');
text_row_ex(_("D.G of Finance Code :"), 'dg_fin_code', 25);
...
//PO Authorization Limit
small_amount_row(_("Authorization Required to PO Amount :"), 'po_auth_req_amount', null, '');
...
label_row(_("Use Dimensions"), $_POST['use_dimension']);
hidden('use_dimension',1);
