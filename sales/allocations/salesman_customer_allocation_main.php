...
page(_($help_context = "Customer Allocations (SalesManwise)"), false, false, "", $js);
...
if (isset($_GET['sales_person_ref']))
{
	$_POST['sales_person_ref'] = $_GET['sales_person_ref'];
	$sales_person_ref = $_POST['sales_person_ref'];
}
...
function alloc_link($row)
{
	return pager_link(_("Allocate"),
		"/sales/allocations/salesman_customer_allocate.php?trans_no="
			.$row["trans_no"] . "&trans_type=" . $row["type"]. "&debtor_no=" . $row["debtor_no"]. "&sales_person_ref=" . $row["sales_person_ref"], ICON_ALLOC);
}
...
$sql = get_salesman_wise_allocatable_from_cust_sql($customer_id, $_POST['sales_person_ref'], $settled);
