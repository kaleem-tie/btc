...
if (isset($_POST['Process']))
{
	...
	if (check_allocations())
	{
		...
		if($_SESSION['alloc']->type==12)
		   $sales_per_ref = get_cust_payment_sales_person_ref($_SESSION['alloc']->trans_no);
		else if($_SESSION['alloc']->type==5)
			$sales_per_ref = get_cust_pdc_sales_person_ref($_SESSION['alloc']->trans_no);
...
if (isset($_POST['Cancel']))
{
	...
	clear_allocations();
	meta_forward($path_to_root . "/sales/allocations/salesman_customer_allocation_main.php?sales_person_ref=$sales_per_ref");
}
