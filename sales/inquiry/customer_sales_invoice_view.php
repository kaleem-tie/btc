...
***********************************************************************/
$page_security = 'SA_SALES_INV_INQ';
$path_to_root = "../..";
...
page(_($help_context = "Sales Invoice Inquiry"), isset($_GET['customer_id']), false, "", $js);
...
if (!$page_nested)
 ...
 //ref_cells(_("Invoice No.:"), 'trans_no'); 
...
$sql = get_sql_for_customer_inquiry(get_post('TransAfterDate'), get_post('TransToDate'),
	get_post('customer_id'), 1, check_value('show_voided'),$_POST['Dimension'], $_POST['Dimension2'],$_POST['trans_no']);
