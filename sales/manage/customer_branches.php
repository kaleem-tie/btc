...
/*	if (strlen($_POST['br_ref']) == 0)
	...
	if (strlen($_POST['br_address']) == 0) 
	{
		display_error(_("The customer branch address cannot be empty."));
		set_focus('br_address');
		return false;
	} 
	...
	if ($input_error != 1)
	{
    	...
    	if ($selected_id != -1)
		{
			update_branch($_POST['customer_id'], $_POST['branch_code'], $_POST['br_name'], $_POST['br_name'],
				...
				$_POST['vat_reg'], $_POST['tax_id']);

			$note =_('Selected customer branch has been updated');
  		}
		else
		{
			add_branch($_POST['customer_id'], $_POST['br_name'], $_POST['br_name'],
				$_POST['br_address'], $_POST['salesman'], $_POST['area'], $_POST['tax_group_id'], $_POST['sales_account'],
				$_POST['sales_discount_account'], $_POST['receivables_account'], $_POST['payment_discount_account'],
				$_POST['default_location'], $_POST['br_post_address'], $_POST['group_no'],
				$_POST['default_ship_via'], $_POST['notes'], $_POST['bank_account'],
...
function branch_settings($selected_id, $num_branches) {
	...
	text_row(_("Branch Name:<b style='color:red;'>*</b>"), 'br_name', null, 50, 60);
	// text_row(_("Branch Short Name:<b style='color:red;'>*</b>"), 'br_ref', null, 30, 30);
	...
	if($selected_id==-1) {
		...
		text_row(_("Phone Number:<b style='color:red;'>*</b>"), 'phone', null, 32, 30);
