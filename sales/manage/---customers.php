...
function handle_submit(&$selected_id)
{
	...
	if ($selected_id) 
	{
		update_customer($_POST['customer_id'], $_POST['CustName'], $_POST['cust_ref'], $_POST['address'],
			...
			$_POST["vat_effective_date"],$_POST["tax_card_no"],$_POST["vat_status"]);
	...
	{ 	//it is a new customer
		...
		add_customer($_POST['CustName'], $_POST['cust_ref'], $_POST['address'],
			...
			$_POST["business_type_id"],$_POST["vat_reg"],$_POST["vat_renewal_date"],$_POST["vat_effective_date"],$_POST["tax_card_no"],$_POST["vat_status"]);
...
function customer_settings($selected_id) 
{
	...
	elseif (isset($SysPrefs->auto_create_branch) && $SysPrefs->auto_create_branch == 1)
	{
		...
		email_row(_("E-mail:<b style='color:red;'>*</b>"), 'email', null, 35, 55);
